...
propensity_model <- svyglm(treatment ~ Sex + AgeR + region + country, design = DS_individuals_exploration_10042024_weighted, family = gaussian()) 

propensity_model <- glm(treatment ~ Sex + AgeR, family = gaussian(), data = DS_individuals_exploration_10042024_full, weights = FinalWeight)
