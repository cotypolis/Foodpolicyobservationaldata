...
DS_individuals_exploration_10042024[DS_individuals_exploration_10042024 < 0] <- NA

summary <- dfSummary(DS_individuals_exploration_10042024, graph.magnif = 0.75, plain.ascii = FALSE, style = "grid")
...
cont_table <- table(DS_individuals_exploration_10042024$Year, DS_individuals_exploration_10042024$treatment)
cont_table
percent_table <- prop.table(cont_table) * 100
percent_table
cont_table_bmi <- table(DS_individuals_exploration_10042024$Year, DS_individuals_exploration_10042024$bmivg5)
cont_table_bmi
cont_table_pol <- table(DS_individuals_exploration_10042024$Year, DS_individuals_exploration_10042024$post_policy)
cont_table_pol
...
DS_individuals_exploration_10042024$adjustedweight <- DS_individuals_exploration_10042024$Weight * 15655

#Multiply each by the combined sum of the four weights

DS_individuals_exploration_10042024$FinalWeight <- ifelse(DS_individuals_exploration_10042024$Year >= 2009 & DS_individuals_exploration_10042024$Year <= 2012, 
                           (DS_individuals_exploration_10042024$adjustedweight / 6828) * 0.3636, 
...
DS_individuals_exploration_10042024$FinalWeight <- ifelse(DS_individuals_exploration_10042024$Year >= 2009 & DS_individuals_exploration_10042024$Year <= 2012, 
                           (DS_individuals_exploration_10042024$adjustedweight / 6828) * 0.3636,
                           ifelse(DS_individuals_exploration_10042024$Year >= 2013 & DS_individuals_exploration_10042024$Year <= 2014,
                                  (DS_individuals_exploration_10042024$adjustedweight  / 2546) * 0.1818,
                                  ifelse(DS_individuals_exploration_10042024$Year >= 2015 & DS_individuals_exploration_10042024$Year <= 2016,
                                         (DS_individuals_exploration_10042024$adjustedweight  / 2723) * 0.1818,
                                         ifelse(DS_individuals_exploration_10042024$Year >= 2017 & DS_individuals_exploration_10042024$Year <= 2019,
                                                (DS_individuals_exploration_10042024$adjustedweight  / 3558) * 0.2727,
                                                NA))))  # NA for years outside specified ranges


mean_final_weight_per_year <- aggregate(FinalWeight ~ Year, DS_individuals_exploration_10042024, mean, na.rm = TRUE)
print(mean_final_weight_per_year)

mean_final_weight_per_year2 <- aggregate(Weight2 ~ Year, DS_individuals_exploration_10042024, mean, na.rm = TRUE)
print(mean_final_weight_per_year2)
...
did_model1 <- lm(`Sum of Energykcal` ~ treatment * post_policy, data = DS_individuals_exploration_10042024)

did_model2 <- lm(`Sum of EnergykJ` ~ treatment * post_policy, data = DS_individuals_exploration_10042024)

did_model3 <- lm(`Sum of FoodEkcal` ~ treatment * post_policy, data = DS_individuals_exploration_10042024)

did_model4 <- lm(`Sum of FoodEkJ` ~ treatment * post_policy, data = DS_individuals_exploration_10042024)
...
did_model1_w <- lm(`Sum of Energykcal` ~ treatment * post_policy + FinalWeight, data = DS_individuals_exploration_10042024)

did_model2_w <- lm(`Sum of EnergykJ` ~ treatment * post_policy + FinalWeight, data = DS_individuals_exploration_10042024)

did_model3_w <- lm(`Sum of FoodEkcal` ~ treatment * post_policy + FinalWeight, data = DS_individuals_exploration_10042024)

did_model4_w <- lm(`Sum of FoodEkJ` ~ treatment * post_policy + FinalWeight, data = DS_individuals_exploration_10042024)
...
did_model1_w_c <- lm(`Sum of FoodEkcal` ~ treatment * post_policy + FinalWeight + Sex, data = DS_individuals_exploration_10042024)

did_model2_w_c <- lm(`Sum of FoodEkcal` ~ treatment * post_policy + FinalWeight + Sex + AgeR, data = DS_individuals_exploration_10042024)

did_model3_w_c <- lm(`Sum of FoodEkcal` ~ treatment * post_policy + FinalWeight + Sex + AgeR + region, data = DS_individuals_exploration_10042024)

did_model4_w_c <- lm(`Sum of FoodEkcal` ~ treatment * post_policy + FinalWeight + Sex + AgeR + region + country, data = DS_individuals_exploration_10042024)
...
library(dplyr)
DS_individuals_exploration_10042024_filtered <- DS_individuals_exploration_10042024 %>%
...
adjusted_plot_data <- DS_individuals_exploration_10042024 %>%
  group_by(Year, treatment) %>%
  summarise(mean_outcome = mean(`Sum of Energykcal`, na.rm = TRUE),
...
# Adjust the outcome by the mean of FinalWeight for each group and year
adjusted_plot_data2 <- DS_individuals_exploration_10042024 %>%
  group_by(Year, treatment) %>%
  summarise(mean_outcome = mean(`Sum of EnergykJ`, na.rm = TRUE),
            mean_final_weight = mean(FinalWeight, na.rm = TRUE)) %>%
  mutate(adjusted_mean_outcome = mean_outcome / mean_final_weight) %>%
...
# Adjust the outcome by the mean of FinalWeight for each group and year
adjusted_plot_data3 <- DS_individuals_exploration_10042024 %>%
  group_by(Year, treatment) %>%
  summarise(mean_outcome = mean(`Sum of FoodEkcal`, na.rm = TRUE),
            mean_final_weight = mean(FinalWeight, na.rm = TRUE)) %>%
  mutate(adjusted_mean_outcome = mean_outcome / mean_final_weight) %>%
...
# Adjust the outcome by the mean of FinalWeight for each group and year
adjusted_plot_data4 <- DS_individuals_exploration_10042024 %>%
  group_by(Year, treatment) %>%
  summarise(mean_outcome = mean(`Sum of FoodEkJ`, na.rm = TRUE),
            mean_final_weight = mean(FinalWeight, na.rm = TRUE)) %>%
  mutate(adjusted_mean_outcome = mean_outcome / mean_final_weight) %>%
...
```
## Statistics for food categories


```{r summary2, echo=FALSE, results='asis'}

#library(haven)
#ndns_rp_yr11a_foodleveldietarydata_uk_20210831 <- read_dta("C:/Users/n51867ca/OneDrive - The University of Manchester/R/National Diet and Nutrition Survey 1-11, #2008-2019/stata/stata13_se/ndns_rp_yr11a_foodleveldietarydata_uk_20210831.dta")

# Convert the problematic strings to UTF-8 encoding
#ndns_rp_yr11a_foodleveldietarydata_uk_20210831$Name <- stri_enc_toutf8(data$Name)
